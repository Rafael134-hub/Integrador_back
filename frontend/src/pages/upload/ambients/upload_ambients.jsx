...
export function Upload_ambients() {
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/api/upload-xlsx-ambientes/', formData, {
                headers: {
                    ...
                    <div className="h-screen bg-gradient-to-bl from-sky-900 via-teal-400 to-green-400">
                        <div className="h-[100vh] flex items-center justify-center">
                            <form className="bg-white w-[24vw] h-[54vh] flex flex-col items-center justify-center rounded-4xl text-black mb-[15vh]">
                                <h1 className="mb-6 text-4xl text-sky-500 font-bold">Importar ambientes</h1>
                                <input
                                    type="file"
